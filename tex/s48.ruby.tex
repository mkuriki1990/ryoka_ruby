...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{西方}{せいほう}\ruby{空}{そら}を\ruby{眺}{}むれば\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{素}{もと}\ruby{月}{つき}\ruby{東}{ひがし}の\ruby{森}{もり}に\ruby{出}{で}ず\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 3.
        \ruby{浜}{はま}\ruby{茄子}{なすび}の\ruby{砂丘}{さきゅう}たたずみて\\
        はるかに\ruby{眺}{}むオホーツク\\
        \ruby{知床}{しれとこ}の\ruby{嶺}{みね}\ruby{雪}{ゆき}かぶり\\
        \ruby{沈}{しず}む\ruby{入日}{いりひ}に\ruby{白鳥}{はくちょう}の\\
        \ruby{飛}{ひ}\ruby{影}{かげ}ぞ\ruby{哀}{かな}しく\ruby{消}{き}え\ruby{去}{さ}りぬ
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{一}{いち}\ruby{年}{ねん}\ruby{涙}{なみだ}\ruby{胸}{むね}に\ruby{秘}{ひ}め\\
