...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{遙}{}かなるかな\ruby{我}{わが}\ruby{思}{おも}ひ\\
        \ruby{無}{む}\ruby{相}{そう}の\ruby{智慧}{ちえ}を\ruby{追}{つい}ひ\ruby{求}{もと}めつ、\\
        \ruby{無明}{むみょう}の\ruby{闇}{やみ}をわけ\ruby{入}{い}りて\\
        \ruby{生命}{せいめい}の\ruby{流}{なが}れ\ruby{深}{ふか}くも\ruby{進}{すす}む\\
        \ruby{雄}{}\ruby{々}{おお}しき\ruby{學}{まなぶ}\ruby{徒}{と}こヽ\ruby{北}{きた}にあり
