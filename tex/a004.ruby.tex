...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby{流}{ながれ}るヽ\ruby{光}{ひかり}\ruby{途}{と}\ruby{重}{かさ}ね\ruby{來}{}て\\
        \ruby{星霜}{せいそう}\ruby{此處}{}に\ruby{四}{よん}\ruby{十}{じゅう}\ruby{年}{ねん}\\
        ...
        \ruby{誰}{だれ}か\ruby{血汐}{ちしお}の\ruby{湧}{わ}かざらむ
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{嫩草}{}\ruby{萠}{めぐむ}ゆる\ruby{北}{きた}の\ruby{郷}{さと}\\
        \ruby{手稲}{ていね}の\ruby{麓}{ふもと}\ruby{健兒}{けんじ}\ruby{等}{とう}が\\
        \ruby{燃}{}ゆる\ruby{想}{そう}を\ruby{合唱}{がっしょう}せば\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{静}{せい}けき\ruby{秋}{あき}のめぐり\ruby{來}{}て\\
        ...
        \ruby{自然}{しぜん}の\ruby{愛}{あい}に\ruby{狎}{}るヽ\ruby{哉}{}
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 6.
        \ruby{萬}{よろず}\ruby{里}{さと}\ruby{茫々}{ぼうぼう}\ruby{雪}{ゆき}の\ruby{海}{うみ}\\
        \ruby{白}{はく}\ruby{龍}{りゅう}\ruby{怒}{いか}り\ruby{風}{ふう}\ruby{叫}{さけ}ぶ\\
