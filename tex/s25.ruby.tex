...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby{悠遠}{ゆうえん}き\ruby{日}{ひ}にあこがれて\\
        \ruby{我}{わが}は\ruby{来}{こ}たりぬ\\
        \ruby{北国}{きたぐに}の\ruby{詩}{し}の\ruby{都}{と}ぞ\\
        やはらかき\ruby{緑}{みどり}の\ruby{芝生}{しばふ}\\
        \ruby{美}{び}はしき\ruby{小川}{おがわ}の\ruby{畔}{ほとり}\\
        \ruby{清明}{せいめい}の\ruby{森}{もり}\ruby{蔭}{かげ}\ruby{深}{ふか}く\ruby{訪}{たず}ね\ruby{来}{き}て\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{四}{よん}\ruby{十}{じゅう}\ruby{三}{さん}\ruby{回}{かい}\ruby{記念祭}{きねんさい}\ruby{巡}{めぐ}りて\\
        \ruby{光栄}{こうえい}あれ\ruby{伝統}{でんとう}の\ruby{法}{ほう}\ruby{燈}{}\\
        \ruby{星辰}{せいしん}\ruby{清}{きよ}きエルムの\ruby{学園}{がくえん}に\ruby{甦}{よみがえ}へりたる\\
        \ruby{鐘}{かね}の\ruby{音}{おと}は\ruby{高}{たか}く\ruby{鳴}{な}るなり
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        あかつきは\ruby{紫}{むらさき}の\\
        \ruby{夢}{ゆめ}にけむれり\\
        \ruby{雪}{ゆき}\ruby{解}{かい}なる\ruby{陵}{りょう}にのぼりて\\
        \ruby{恋}{こい}ひ\ruby{慕}{}ふ\ruby{意気}{いき}と\ruby{血汐}{ちしお}の\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{森}{もり}\ruby{蔭}{かげ}に\ruby{心情}{しんじょう}は\ruby{燃}{も}えて\\
