...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 2.
        \ruby{沈黙}{ちんもく}の\ruby{楡}{にれ}\ruby{林}{りん}のほの\ruby{暗}{ほのぐら}く\\
        \ruby{友}{とも}と\ruby{高}{こう}\ruby{望}{もち}を\ruby{語}{かた}りてし\\
        \ruby{三}{さん}\ruby{年}{ねん}の\ruby{夢}{ゆめ}は\ruby{淡}{あわ}くとも\\
        \ruby{羽}{はね}\ruby{搏}{}かんかな\ruby{大}{だい}\ruby{鳳}{おおとり}は\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{猛}{もう}き\ruby{遊児}{}の\ruby{熱血}{ねっけつ}は\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{今日}{きょう}\ruby{四}{よん}\ruby{十}{じゅう}\ruby{回}{かい}の\ruby{記念}{きねん}\ruby{祭}{さい}\\
        \ruby{浩}{ひろし}\ruby{歌}{か}はんかな\ruby{吾}{わ}が\ruby{友}{とも}よ
