...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{吾}{われ}が\ruby{世}{よ}の\ruby{状態}{じょうたい}を\ruby{眺}{ながむ}むれば\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{欧米}{おうべい}の\ruby{空}{そら}\ruby{今正}{いままさ}に\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{人和}{れんほう}\ruby{豈}{あに}それなからんや\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        シベリヤ\ruby{斧}{おの}を\ruby{振}{ふ}ふ\ruby{可}{ふか}し\\
