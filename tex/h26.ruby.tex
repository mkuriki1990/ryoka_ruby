...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{穹蒼}{}の\ruby{天空}{てんくう}\ruby{高}{たか}く\\
        \ruby{舞}{まい}ひたる\ruby{月}{つき}は\ruby{今宵}{こよい}\ruby{満}{まん}つるかな。\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{風習}{ふうしゅう}に\ruby{付}{ふ}\ruby{和}{わ}せし\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        かの\ruby{日}{ひ}の\ruby{月影}{つきかげ}とは\ruby{違}{}へども\\
        \ruby{人世}{じんせい}(よ)に\ruby{充}{み}つ\ruby{解答}{かいとう}を\ruby{自}{おの}ずと\ruby{心得}{こころえ}\\
        \ruby{此}{}れは\ruby{汝}{なんじ}の\ruby{求}{もとめ}\ruby{望}{もち}にか\\
        \ruby{漲}{みなぎ}る\ruby{想}{そう}ひ などか\ruby{劣}{おと}らむ\\
        さて\ruby{映}{うつ}りこむ \ruby{我}{わ}が\ruby{鏡}{かがみ}\ruby{瞳}{ひとみ}に\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{今宵}{こよい}も\ruby{我}{わが}は\ruby{朧月}{おぼろづき}を\ruby{仰}{ぎょう}がむ\\
        \ruby{姫}{ひめ}が\ruby{麗姿}{れいし}を\ruby{追憶}{ついおく}ふべく\\
        \ruby{汝}{なんじ}が\ruby{想}{そう}ひは\ruby{涙}{なみだ}と\ruby{落}{}\ruby{流}{なが}れ\\
