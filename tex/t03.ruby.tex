...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{千}{せん}ひろの\ruby{海}{うみ}の\ruby{真珠}{しんじゅ}\ruby{取}{と}り\\
        \ruby{美}{よし}\ruby{想}{そう}にあこがるる\ruby{身}{み}は\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 2.
        \ruby{永遠}{えいえん}に\ruby{華}{はな}さく\ruby{水底}{すいてい}ふかく\\
        ...
        \ruby{七}{なな}\ruby{重}{じゅう}の\ruby{潮}{しお}の\ruby{妙音}{みょうおん}にひびく\\
        \ruby{美}{よし}\ruby{珠}{たま}こそわれの\ruby{生命}{せいめい}なれ
