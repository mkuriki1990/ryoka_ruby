...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby{春猶}{はるなお}\ruby{淺}{}し\ruby{北}{きた}\ruby{溟}{}の\ruby{州}{しゅう}\\
        \ruby{雪消}{ゆきげ}のましみづ\ruby{併}{あわ}せ\ruby{來}{らい}る\\
        \ruby{石狩川}{いしかりがわ}の\ruby{清流}{せいりゅう}にも\\
        \ruby{我}{が}\ruby{等}{とう}が\ruby{力}{ちから}\ruby{譬}{}ふべし\\
        \ruby{健}{けん}き\ruby{心}{こころ}の\ruby{丈夫}{じょうぶ}は\\
        \ruby{脾肉}{ひにく}の\ruby{嘆}{たん}を\ruby{喞}{}つ\ruby{哉}{かな}
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{我}{が}\ruby{等}{とう}が\ruby{承}{う}けし\ruby{伝統}{でんとう}の\\
        \ruby{歴史}{れきし}は\ruby{經}{たて}りて\ruby{十五年}{じゅうごねん,じゅーごねん}
