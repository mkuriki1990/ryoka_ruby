...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{我}{が}が\ruby{行}{い}く\ruby{方}{ほう}の\ruby{遠}{とお}ければ\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{我}{が}\ruby{等}{とう}の\ruby{群}{ぐん}に\ruby{加}{か}はらん
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{友}{とも}も\ruby{歌}{うた}えば\ruby{我}{が}も\ruby{和}{わ}し\\
        \ruby{来}{く}るはここぞ\ruby{森}{もり}の\ruby{奥}{おく}\\
        \ruby{光}{ひかり}まばゆき\ruby{自治}{じち}の\ruby{燈}{あかり}
