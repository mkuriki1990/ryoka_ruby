...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{燃}{もゆる}ゆる\ruby{姿}{すがた}に\ruby{似}{に}たる\ruby{哉}{かな}\\
        \ruby{嘶}{いなな}く\ruby{駒}{こま}は\ruby{秋}{あき}に\ruby{肥}{こ}え\\
        \ruby{我等}{われら}が\ruby{門出}{かどで}\ruby{栄}{さかえ}ありき
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{大野}{おおの}の\ruby{果}{はて}を\ruby{眺}{ながむ}むれば\\
        \ruby{雪}{ゆき}かあられか\ruby{空}{そら}たえて\\
        \ruby{限}{かぎ}りは\ruby{知}{し}らず\ruby{暮}{くれ}るとも\\
        \ruby{我等}{われら}が\ruby{胸}{むね}に\ruby{黙想}{もくそう}あり\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{物}{もの}\ruby{皆}{みな}\ruby{此処}{ここ}に\ruby{力}{ちから}あり
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{色}{いろ}を\ruby{交}{よしみ}へて\ruby{咲}{さ}く\ruby{花}{はな}に\\
        \ruby{蝶舞}{かれん}ひ\ruby{鳥}{とり}は\ruby{囀}{さえず}りて\\
        \ruby{我等}{われら}が\ruby{血潮}{ちしお}\ruby{躍}{おど}るなり\\
        \ruby{斯}{か}くて\ruby{見渡}{みわた}す\ruby{行手}{ゆくて}には\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 6.
        \ruby{四年}{よんねん,よんねん}の\ruby{昔}{むかし}\ruby{人々}{ひとびと}の\\
        \ruby{耘}{}り\ruby{建}{た}てし\ruby{我}{われ}が\ruby{寮}{りょう}に\\
        \ruby{春}{はる}\ruby{立}{た}ち\ruby{還}{かえ}る\ruby{時}{とき}よ\ruby{今}{いま}\\
        \ruby{希望}{きぼう}の\ruby{光}{ひかり}\ruby{新}{しん}なり\\
        さらば\ruby{起}{た}て\ruby{友}{とも}\ruby{諸共}{もろとも}に\\
        \ruby{我等}{われら}\ruby{起}{た}つべき\ruby{時}{とき}なれば
