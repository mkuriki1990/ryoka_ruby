...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{蓁萋}{}ゆらぐ\ruby{風}{かぜ}\ruby{有}{あ}れど\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{黄}{き}\ruby{鶴}{つる}\ruby{消}{き}えて\ruby{姿}{すがた}\ruby{無}{な}し\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 4.
        \ruby{鐘}{かね}の\ruby{音}{おと}\ruby{遠}{とお}く\ruby{聞}{きこ}えども\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 6.
        \ruby{未明}{みめい}に\ruby{懸}{かか}る\ruby{白}{しろ}き\ruby{月}{つき}\\
        \ruby{夢見}{ゆめみ}し\ruby{思}{おも}う\ruby{北}{きた}\ruby{溟}{}の\ruby{海}{うみ}\\
        \ruby{憧}{あこが}れ\ruby{来}{きた}しは\ruby{北}{きた}\ruby{溟}{}の\ruby{峰}{みね}\\
        \ruby{呼}{こ}\ruby{々}{々}\ruby{我}{わが}\ruby{前途}{ぜんと}の\ruby{行}{い}く\ruby{果}{はて}は
