...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby{楡陵}{おか}に\ruby{月}{つき}は\ruby{懸}{かか}れども\\
        \ruby{星霜}{せいそう}\ruby{深}{ふか}き\ruby{原始林}{もり}\ruby{暗}{くら}し\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{石狩}{いしかり}の\ruby{野}{の}\ruby{今}{こん}\ruby{何処}{いずこ}
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{永遠}{えいえん}の\ruby{生命}{いのち}を\ruby{誦}{}わなん
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{憧}{あこが}れ\ruby{来}{こ}しは\ruby{北}{きた}\ruby{溟}{}の\ruby{峰}{みね}\\
        \ruby{呼}{こ}々\ruby{我}{われ}\ruby{前途}{ぜんと}の\ruby{行}{い}く\ruby{果}{はて}は
