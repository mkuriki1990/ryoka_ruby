...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{春}{はる}\ruby{新生}{しんせい}の\ruby{精気}{せいき}は\ruby{溢}{}る\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{白鳥}{はくちょう}\ruby{高}{たか}く\ruby{海}{うみ}に\ruby{飛}{と}び\\
        \ruby{入江}{いりえ}の\ruby{波}{なみ}に\ruby{夏}{なつ}\ruby{陽}{よう}は\ruby{映}{うつ}ゆる
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{高}{こう}\ruby{遠}{とお}き\ruby{感激}{かんげき}に\ruby{逍遙}{}ふ\ruby{哉}{}
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{胸}{むね}に\ruby{高}{}\ruby{鳴}{たかな}る\ruby{青春}{せいしゅん}の\\
