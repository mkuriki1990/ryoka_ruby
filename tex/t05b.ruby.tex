...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby{荒潮}{あらしお}\ruby{繞}{にょう}る\ruby{北}{きた}の\ruby{郷}{さと}\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{十一}{じゅういっ}の\ruby{年}{とし}の\ruby{旦暮}{たんぼ}は\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{流光}{りゅうこう}\ruby{高}{たか}く\ruby{際涯}{さいがい}なき\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 5.
        \ruby{北風}{きたかぜ}\ruby{胡沙}{こさ}に\ruby{雪}{ゆき}を\ruby{捲}{ま}き\\
        \ruby{荒}{あ}れ\ruby{狂}{きょう}ひたる\ruby{戦場}{せんじょう}の\ruby{跡}{あと}\\
        \ruby{暮}{く}れ\ruby{行}{い}く\ruby{蛮}{ばん}\ruby{霧}{きり}に\ruby{包}{つつ}まれて\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{調}{ちょう}\ruby{新}{あたら}しく\ruby{唱}{とのお}はなん
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{曲}{きょく}\ruby{勇}{いさ}ましく\ruby{唱}{とのお}はなむ
