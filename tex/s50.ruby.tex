...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{遙}{}かな\ruby{大地}{だいち}は\ruby{何}{なに}\ruby{語}{かた}るらん\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{曠野}{あらの}を\ruby{一}{いち}\ruby{人}{にん}ゆく\ruby{吾}{われ}\ruby{佇}{たたず}めば\\
        \ruby{日輪}{にちりん}\ruby{幽寂}{ゆうじゃく}に\ruby{手稲}{ていね}の\ruby{端}{はじ}にて\\
        \ruby{朱}{しゅ}に\ruby{染}{そ}まらん\ruby{哉}{}\ruby{原始}{げんし}の\ruby{森}{もり}は
