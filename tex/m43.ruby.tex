...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{紅}{べに}\ruby{塵}{ちり}\ruby{絶}{た}えて\ruby{空}{そら}\ruby{潔}{いさぎよ}く\\
        \ruby{蕭々}{しょうしょう}として\ruby{水}{みず}\ruby{寒}{さむ}し\\
        \ruby{大陸}{たいりく}の\ruby{精}{せい}\ruby{鍾}{}まりて\\
        \ruby{我}{わが}\ruby{北}{きた}\ruby{州}{しゅう}の\ruby{島}{しま}と\ruby{凝}{こ}る
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 2.
        \ruby{鯨}{くじら}\ruby{群}{ぐん}\ruby{吼}{}ゆる\ruby{荒}{あら}\ruby{潮}{しお}に\\
        \ruby{落}{お}つる\ruby{北斗}{ほくと}の\ruby{影}{かげ}\ruby{冴}{さ}えて\\
        \ruby{斧鉞}{ふえつ}\ruby{入}{はい}らざるや\ruby{森林}{しんりん}や\\
        \ruby{人}{ひと}\ruby{跡}{}\ruby{絶}{とだ}えし\ruby{大野原}{おおのはら}\\
        \ruby{原始}{げんし}の\ruby{儘}{}の\ruby{俤}{おもかげ}を\\
        \ruby{我}{わが}\ruby{北}{きた}\ruby{州}{しゅう}の\ruby{島}{しま}に\ruby{見}{み}る
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{楡}{にれ}の\ruby{下}{しも}\ruby{蔭}{かげ}\ruby{草}{くさ}\ruby{繁}{しげ}る\\
        \ruby{霜}{しも}\ruby{葉}{は}\ruby{燃}{}ゆる\ruby{蔦葛}{つたかずら}\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 4.
        \ruby{朝霧}{あさぎり}\ruby{深}{ふか}き\ruby{野}{の}の\ruby{面}{めん}に\\
        ...
        プラウの\ruby{土}{ど}を\ruby{払}{}ふ\ruby{時}{とき}\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{地}{ち}は\ruby{広漠}{こうばく}の\ruby{沖}{おき}\ruby{積層}{せきそう}
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 6.
        \ruby{此聖}{}\ruby{都}{と}を\ruby{永久}{えいきゅう}に\\
        \ruby{浮華}{ふか}\ruby{軽佻}{けいちょう}の\ruby{国}{くに}とせず\\
        \ruby{真摯}{しんし}\ruby{素樸}{そぼく}の\ruby{郷}{さと}となし\\
        \ruby{我}{わが}\ruby{等}{とう}が\ruby{使命}{しめい}\ruby{成}{な}し\ruby{遂}{と}げん\\
