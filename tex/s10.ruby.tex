...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 2.
        \ruby{三}{さん}\ruby{年}{ねん}の\ruby{契}{ちぎり}\ruby{浅}{あさ}からず\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{夏}{なつ}\ruby{草}{}\ruby{深}{くさぶか}き\ruby{丘上}{おかうえ}に\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 4.
        \ruby{不壊}{ふえ}の\ruby{生命}{せいめい}と\ruby{輝}{かがや}きし\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 5.
        \ruby{颯々}{さっさつ}の\ruby{風}{かぜ}\ruby{音}{おと}\ruby{寒}{さむ}く\\
        \ruby{橇}{そり}の\ruby{音}{おと}\ruby{孤}{こ}\ruby{絃}{}の\ruby{月}{つき}を\ruby{呼}{よ}ぶ\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{篝火}{かがりび}\ruby{焚}{た}きて\ruby{我}{わが}は\ruby{今}{こん}\\
