...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{歌}{うた}ふなり\\
        \ruby{自治}{じ|ち}と\ruby{自由}{じ|いう}の\ruby{高}{たか}き\ruby{誇}{ほこり}を
        
        \vspace{\linespace}
        \item~\\
        % 2.
        \ruby[g]{六十年}{むそとせ}の\ruby{青史}{せい|し}は\ruby{薫}{かを}り\\
        \ruby{郭公}{くわく|こう}の\ruby[g]{啼声}{こゑ}もはるかに\\
        \ruby{紺青}{こん|じやう}の\ruby{入相}{いり|あひ}の\ruby{空}{そら}\\
        \ruby{魂}{たましい}は\ruby{虚空}{こ|くう}に\ruby{走}{は}せて\\
        \ruby[g]{住昔}{ふるきよ}の\ruby[g]{意気}{こころ}を\ruby{慕}{した}ふ\\
        \ruby{尽}{つ}きるなき\ruby{川}{かは}のせせらぎ\\
        \ruby{夢}{ゆめ}ふかし\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby[g]{落葉}{から}\ruby{松}{まつ}の\ruby{林}{はやし}\ruby[g]{時雨}{しぐ}れて\\
        \ruby{{\CID{18947}}々}{しう|しう}の\ruby{悲歌}{ひ|か}の\ruby{調}{しら}べは\\ % CID 颼
        ...
        \ruby[g]{際涯}{はてし}なき\ruby{雪}{ゆき}の\ruby{荒野}{くわう|や}に\\
        \ruby{皎々}{かう|かう}と\ruby[g]{月光}{つきかげ}\ruby{冴}{さ}ゆる\\
        \ruby{橇}{そり}の\ruby{音}{ね}の\ruby[g]{玻窓}{まど}にこほりて\\
        \ruby{限}{かぎ}りなき\ruby[g]{瞑想}{おもひ}をさそふ\\
        \ruby{悠久}{いう|きう}の\ruby{時}{とき}の\ruby[g]{流転}{うつろひ}\\
        \ruby{人}{ひと}の\ruby{世}{よ}の\\
        \ruby{悲}{かな}しき\ruby[g]{運命}{さだめ}ぞ\ruby[g]{明日}{あす}の\ruby{旅路}{たび|ぢ}は
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        いざ\ruby[g]{寮友}{とも}よ\\
        のこりの\ruby{春}{はる}を\ruby{惜}{を}しまざらめや
