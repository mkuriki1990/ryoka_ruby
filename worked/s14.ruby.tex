...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby{時潮}{じ|てう}の\ruby[g]{流転}{ながれ}\ruby{淙々}{そう|そう}と\\
        \ruby[g]{四季}{とき}\ruby{乾坤}{けん|こん}に\ruby{巡}{めぐ}り\ruby{立}{た}つ\\
        \ruby{去来}{きょ|らい}\ruby{常}{つね}なく\ruby{人}{ひと}\ruby{変}{かは}り\\
        \ruby{有情}{う|じやう}\ruby{無為}{む|ゐ}の\ruby[g]{時鐘}{かね}の\ruby{音}{ね}に\\
        \ruby{孤城}{こ|じやう}の\ruby[g]{爽春}{はる}は\ruby{未}{ま}だ\ruby{浅}{あさ}し
        
        \vspace{\linespace}
        \item~\\
        % 2.
        \ruby{遠}{とほ}く\ruby[g]{流離}{りうり}の\ruby{春}{はる}に\ruby{来}{き}て\\
        \ruby{此}{こ}の\ruby[g]{高楼}{たかどの}に\ruby[g]{春愁}{うれ}ひつつ\\
        \ruby{郭公}{くわく|こう}\ruby{鳥}{とり}の\ruby{鳴}{な}くさへも\\
        \ruby{多感}{た|かん}の\ruby{児等}{こ|ら}の\ruby[g]{情懐}{むね}\ruby{熱}{あつ}く\\
        \ruby{懐古}{くわい|こ}の\ruby{涙}{なみだ}\ruby[g]{{\CID{7635}}}{あふ}るべし % CID 溢
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{桃李}{たう|り}の\ruby[g]{華影}{かげ}は\ruby{痩}{や}せゆきて\\
        ...
        \ruby{暮秋}{ぼ|しう}の\ruby{颯}{かぜ}は\ruby{飄々}{へう|へう}と\\
        \ruby{時艱}{じ|かん}を\ruby{憂}{うれ}ふ\ruby{国}{くに}の\ruby{子}{こ}の\\
        \ruby{悲腸}{ひ|ちやう}の\ruby{声}{こゑ}に\ruby{似}{に}たるかな
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{四寮}{し|れう}の\ruby[g]{高夢}{ゆめ}も\ruby{凍}{い}てつきて\\
        ...
        \ruby{春}{はる}の\ruby{夕}{ゆふ}べの\ruby[g]{宴遊}{うたげ}かな\\
