...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 2.
        \ruby[g]{悲哀}{かなしみ}\ruby{誘}{さそ}ふ\ruby{郭公}{くわく|こう}の\\
        \ruby{声}{こゑ}を\ruby{聞}{き}きつつ\ruby[g]{逍遙}{さまよ}へば\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 3.
        \ruby{牧場}{まき|ば}に\ruby{虫}{むし}の\ruby{音}{ね}も\ruby{淡}{あは}く\\
        \ruby{仰}{あふ}げば\ruby{高}{たか}し\ruby{秋}{あき}の\ruby{空}{そら}\\
        \ruby{肥馬}{ひ|ば}\ruby{原頭}{げん|とう}に\ruby{嘶}{いなな}きて\\
        \ruby{雄渾}{ゆう|こん}の\ruby{気}{き}はあふれつつ\\
        \ruby{崇}{たか}き\ruby{理想}{り|さう}を\ruby{胸}{むね}にして\\
        ...
        \ruby{想}{おも}ひぞ\ruby{馳}{は}する\ruby{北}{きた}\ruby{欧州}{おう|しう}\\
        \ruby[g]{戦{\CID{13325}}}{いくさ}の\ruby{跡}{あと}の\ruby{夕}{ゆふ}まぐれ % CID 禍
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{寒月}{かん|げつ}\ruby{高}{たか}く\ruby{冴}{は}ゆる\ruby{夜半}{よ|は}\\
        ...
        \item~\\
        % 6.
        \ruby{嗚呼}{あ|あ}\ruby{北州}{ほく|しう}の\ruby{春秋}{しゅん|じう}に\\
        ...
        \ruby{先人}{せん|じん}\ruby{建}{た}てし\ruby{自治寮}{じ|ち|れう}の\\
        \ruby{貴}{たふと}き\ruby{歴史}{れき|し}\ruby{伝}{つた}へかし
