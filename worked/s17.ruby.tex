...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby[g]{春{\CID{13831}}}{しゅんしょう}の\ruby{罪}{つみ}と\ruby{誰}{たれ}か\ruby{言}{い}ふ % CID 宵󠄁
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby[g]{今{\CID{13831}}}{こよい}\ruby{銀河}{ぎん|が}の\ruby{祭日}{まつり|び}の\\ % CID 宵󠄁
