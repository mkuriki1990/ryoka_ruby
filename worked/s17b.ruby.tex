...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{十億}{じふ|おく}の\ruby[g]{健剛}{たけき}を\ruby{{\CID{7758}}}{の}みて\\ % CID 禱
        \ruby{国}{くに}\ruby{挙}{こぞ}り\ruby{歩}{あゆ}みゆくなり\\
        \ruby[g]{熱涙}{なみだ}もて\ruby{仰}{あふ}がなむ\\
        \ruby[g]{黎明}{あけ}の\ruby{幸星}{かう|せい}
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{眸}{まみ}\ruby{澄}{す}める\ruby{我等}{われ|ら}\ruby[g]{若人}{わかうど}\\
        \ruby{皇国}{くわう|こく}の\ruby{道}{みち}に\ruby[g]{挺身}{すす}まん\\
        \ruby{諸共}{もろ|とも}に\ruby{雄叫}{を|たけ}びすれば\\
        \ruby{叫}{さけ}び\ruby{和}{わ}す\ruby{新潮}{にひ|しほ}の\ruby{声}{こゑ}\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{仰}{あふ}ぎ\ruby{見}{み}る\ruby{銀漢}{ぎん|が}のほとり\\
