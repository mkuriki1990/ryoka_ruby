...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{白雲}{しら|くも}\ruby{{\CID{13735}}}{そら}に\ruby{行}{ゆき}\ruby{通}{か}ひて\\ % CID 空
        \ruby{羊}{ひつじ}の\ruby{夢}{ゆめ}ぞ\ruby[g]{長閑}{のどか}なる
        
        \vspace{\linespace}
        \item~\\
        % 2.
        さあれ\ruby{{\CID{14011}}和}{へい|わ}の\ruby{夢}{ゆめ}の\ruby{夢}{ゆめ}\\ % CID 平
        \ruby{見}{み}よ\ruby{西欧}{せい|おう}の\ruby{{\CID{13735}}}{そら}の\ruby{様}{よう}\\ % CID 空
        \ruby{怪雲}{かい|うん}\ruby{荒}{すさ}び\ruby[g]{暴風}{あらし}\ruby{吠}{ほ}え\\
        シベリヤ\ruby{春}{はる}の\ruby{色}{いろ}もなく\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{歌}{うた}ごゑ\ruby{高}{たか}き\ruby{春}{はる}\ruby[g]{今{\CID{13831}}}{こよい} % CID 宵󠄁
