...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{源}{みなもと}\ruby{遠}{とほ}く\ruby{霞}{かすみ}\ruby{罩}{こ}め\\
        \ruby{五彩}{ご|さい}を\ruby{染}{そ}むる\ruby{夕照}{ゆふ|やけ}は\\
        \ruby{手稲}{て|いね}の\ruby{夏}{なつ}の\ruby{栄}{はえ}にして\\
        そこに\ruby{無限}{む|げん}の\ruby[g]{恩寵}{めぐみ}あり\\
        \ruby{是}{これ}\ruby{吾}{わが}\ruby{校}{かう}の\ruby{在}{あ}る\ruby{処}{ところ}
        ...
        エルムの\ruby{姿}{すがた}\ruby{壮}{さう}なれや\\
        そこに\ruby{無限}{む|げん}の\ruby[g]{偉力}{ちから}あり\\
        \ruby{是}{これ}\ruby{吾}{わが}\ruby{寮}{れう}の\ruby{在}{あ}る\ruby{処}{ところ}
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 3.
        \ruby{偲}{おも}へば\ruby{遠}{とほ}き\ruby[g]{三十年}{みそとせ}の\\
        \ruby{榛莽}{しん|まう}あしたの\ruby{日}{ひ}を\ruby{蔽}{おほ}ひ\\
        ゆふべの\ruby{月}{つき}に\ruby[g]{羆熊}{くま}\ruby{吼}{ほ}ゆる\\
        \ruby{北海}{ほく|かい}の\ruby{野}{の}に\ruby{鋤入}{すき|い}れて\\
        ...
        \ruby{文明}{ぶん|めい}の\ruby{徳}{とく}は\ruby{尚}{なほ}\ruby{成}{な}らず\\
        \ruby{溟濛天}{めい|もう|てん}に\ruby{漲}{みなぎ}りて\\
        \ruby{帰鳥}{き|てう}\ruby{夕}{ゆふひ}に\ruby[g]{彷徨}{さまよ}ひぬ
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 5.
        \ruby{{\CID{18945}}々}{へう|へう}として % CID 颷
        \ruby{風狂}{かぜ|くる}ひ\\
        ...
        \ruby{起}{た}てるは\ruby{誰}{た}ぞや\ruby{吾}{われ}\ruby{健児}{けん|じ}
        
        \vspace{\linespace}
        \item~\\
        % 6.
        \ruby{岩間}{いわ|ま}に\ruby{咽}{たけ}ぶ\ruby{渓流}{けい|りう}も\\
        ...
        \ruby{魍魎}{まう|りやう}\ruby{遂}{つひ}に\ruby{影}{かげ}もなし
