...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{貴}{とうと}き\ruby[g]{野心}{おもい}ゆめ\ruby{忘}{わす}るまじ\\
        ひたと\ruby{気高}{け|だか}く\\
        ...
        \item~\\
        % 2.
        \ruby[g]{野心}{おもい}は\ruby{強}{つよ}く\ruby{熱}{あつ}くとも\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{曇}{くも}り\ruby{澱}{よど}みし\ruby[g]{過去}{まえ}ではあれど\\
        これより\ruby{先}{さき}は\ruby{我}{われ}らが\ruby{拓}{ひら}かむ\\
        \ruby{先達}{せん|だち}に\ruby{続}{つづ}け\\
        \ruby[g]{大和}{くに}の\ruby{栄}{は}えをば\ruby{担}{にな}うは\ruby{我}{われ}らぞ
