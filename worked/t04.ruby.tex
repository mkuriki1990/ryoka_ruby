...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 3.
        \ruby{柴扉}{さい|ひ}を\ruby{出}{い}でて\ruby{霜}{しも}を\ruby{踏}{ふ}み\\
        ...
        \ruby{友悌}{いう|てい}\ruby{凋}{しほ}まぬ\ruby{松柏}{しょう|はく}と\\
        ...
        \ruby{栄華}{えい|ぐわ}の\ruby{夢}{ゆめ}も\ruby{半}{なかば}にて\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{陣雲}{ぢん|うん}くらき\ruby[g]{八街}{やちまた}は\\
        ...
        \ruby{起}{た}て\ruby{自治寮}{じ|ち|れう}の\ruby{健男児}{けん|だん|じ}
        
        \vspace{\linespace}
        \item~\\
        % 6.
        \ruby{自由}{じ|いう}の\ruby{旗}{はた}を\ruby{振}{ふ}り\ruby{翳}{かざ}し\\
        ...
        \ruby{曠野}{くわう|や}\ruby{虎狼}{こ|らう}の\ruby{影}{かげ}もなし\\
        \ruby{祝}{いは}へ\ruby[g]{今{\CID{13831}}}{こよひ}の\ruby{記念祭}{き|ねん|さい} % CID 宵󠄁
