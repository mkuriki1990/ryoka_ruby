...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{嶮路}{}\ruby{遙}{はる}かに\ruby{辿}{たど}り\ruby{来}{きた}し\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        などて\ruby{疾}{と}く\ruby{過}{す}ぎ\ruby{行}{ゆ}く\ruby{二年}{にねん,にねん}の\ruby{春}{はる}\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % \ruby{結}{ゆい}.
        されど\ruby{視}{み}よ\ruby{我}{が}\ruby{等}{とう}が\ruby{周囲}{しゅうい}を\\
        \ruby{邪悪}{じゃあく}なる\ruby{権力}{けんりょく}は\ruby{四方}{しほう}に\ruby{荒}{すさ}び\\
        \ruby{我}{が}\ruby{等}{とう}が\ruby{愛}{いと}し\ruby{誇}{ほこ}らん\ruby{自治}{じち}の\ruby{砦}{とりで}に\\
