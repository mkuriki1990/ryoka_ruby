...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{看}{み}よ\ruby{極光}{きょく|くわう}に\ruby{照}{て}らされて\\
        ...
        \ruby{十一}{じふ|いち}の\ruby{年}{とし}の\ruby[g]{旦暮}{あけくれ}は\\
        ...
        \ruby{浩蕩}{かう|たう}の\ruby{水}{みづ}\ruby{煌}{きら}めきて\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 4.
        \ruby{夕暮}{ゆふ|ぐれ}\ruby{呼}{よ}ばふ\ruby{閑古鳥}{かん|こ|どり}\\
        \ruby{冥想}{めい|さう}ここに\ruby{始}{はじ}めよと\\
        \ruby{遠}{とほ}\ruby{鳴}{な}くなべも\ruby[g]{紅葉}{もみぢ}しつ\\
        \ruby{稜畳}{りょう|でふ}として\ruby{唐錦}{から|にしき}
        ...
        \ruby{至福}{し|ふく}の\ruby{水}{みづ}を\ruby{掬}{むす}ぶ\ruby{可}{べ}く\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 7.
        \ruby{智慧}{ち|ゑ}の\ruby{光}{ひかり}に\ruby{導}{みちび}かれ\\
        \ruby{熱}{ねつ}の\ruby[g]{磅{\CID{14904}}}{ひそみ}に\ruby{生立}{おひ|た}ちて\\ % CID 礴
