...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{寂}{さび}\ruby{莫}{ばく}のまどろみも\ruby{去}{さ}り\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{高澄}{こうちょう}の\ruby{日高}{ひだか}の\ruby{峠}{とうげ}を\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 4.
        \ruby{白}{しろ}\ruby{皚々}{がいがい}と\ruby{六華}{りっか}は\ruby{咲}{さ}けど\\
        うす\ruby{月}{つき}は\ruby{雲}{くも}をどよませ\\
        \ruby{逆巻}{さかまき}の\ruby{吹雪}{ふぶき}は\ruby{狂}{くる}う\\
        \ruby{邂逅}{かいこう}に\ruby{結}{むす}ぶ\ruby{灯火}{ともしび}\\
        \ruby{濃}{こ}き\ruby{鈍色}{にぶいろ}ににじみそめつも\\
        \ruby{手}{て}をとりて\ruby{声}{ごえ}を\ruby{落}{お}とさじ\\
        \ruby{明晰}{めいせき}な\ruby{眼}{め}を\ruby{持}{も}ちて\ruby{凝視}{ぎょうし}る\ruby{道}{みち}に\\
        わが\ruby{霹靂}{へきれき}の\ruby{痕}{あと}を\ruby{印}{しる}さん
