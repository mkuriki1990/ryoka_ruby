...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{四百余州}{し|ひゃく|よ|しう}に\ruby{吹}{ふ}き\ruby{入}{い}れば\\
        \ruby{聖賢}{せい|けん}\ruby{雲}{くも}と\ruby{叢起}{そう|き}して\\
        \ruby{深}{ふか}き\ruby[g]{思想}{おもひ}は\ruby{東洋}{とう|よう}の\\
        \ruby{青史}{せい|し}\ruby{不朽}{ふ|きう}の\ruby{誇}{ほこり}あり
        
        \vspace{\linespace}
        \item~\\
        % 4.
        \ruby{今}{いま}\ruby{東海}{とう|かい}の\ruby{一}{いち}\ruby{孤島}{こ|とう}\\
        \ruby{文化}{ぶん|か}の\ruby{潮}{うしほ}\ruby{寄}{よ}せ\ruby{来}{きた}り\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{満韓}{まん|かん}の\ruby{原}{はら}\ruby{遺利}{い|り}\ruby{多}{おほ}く\\
        アルゼンタイン\ruby{野}{の}は\ruby{広}{ひろ}し\\
        \ruby{故人}{こ|じん}の\ruby[g]{教訓}{をしへ}\ruby{聴}{き}かざるや\\
        「ビーアンビシァス
        ボーイズ」と
        ...
        \ruby{故人}{こ|じん}の\ruby[g]{教訓}{をしへ}\ruby{膺}{むね}にせよ\\
        「ビーアンビシァス
        ボーイズ」と
