...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{春}{はる}\ruby{新生}{しん|せい}の\ruby[g]{精気}{き}は\ruby{溢}{あふ}る\\
        ...
        \ruby{悠久}{ゆう|きゅう}の\ruby[g]{蒼穹}{そら}はるかにも\\
        \ruby{濃}{こ}き\ruby{水色}{みず|いろ}にうつろへば\\
        \ruby{白鳥}{はく|ちょう}\ruby{高}{たか}く\ruby{海}{うみ}に\ruby{飛}{と}び\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 3.
        \ruby[g]{連嶺}{やま}\ruby{紅}{くれない}に\ruby[g]{黄昏}{たそが}れて\\
        \ruby{夕靄}{ゆう|もや}\ruby{流}{なが}る\ruby{水沼}{すい|しょう}の\\
        ...
        \ruby{雪}{ゆき}の\ruby[g]{曠野}{の}\ruby{遠}{とお}く\ruby[g]{静謐}{しづか}なり\\
        \ruby{銀壺}{ぎん|こ}にゆるる\ruby{灯}{ともしび}に\\
        \ruby{崇}{たか}き\ruby[g]{教訓}{おしへ}を\ruby{胸}{むね}にして\\
        \ruby{心}{こころ}の\ruby[g]{憧憬郷}{さと}にまどゐする\\
        \ruby{若}{わか}き\ruby{人等}{ひと|ら}の\ruby{哀歓}{あい|かん}よ
