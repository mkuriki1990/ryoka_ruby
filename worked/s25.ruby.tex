...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby[g]{悠遠}{とほ}き\ruby{日}{ひ}にあこがれて\\
        \ruby{吾}{われ}は\ruby{来}{き}たりぬ\\
        \ruby{北国}{きた|ぐに}の\ruby{詩}{うた}の\ruby{都}{みやこ}ぞ\\
        やはらかき\ruby{緑}{みどり}の\ruby{芝生}{しば|ふ}\\
        \ruby{美}{うる}はしき\ruby{小川}{お|がわ}の\ruby{畔}{ほとり}\\
        \ruby{清明}{せい|めい}の\ruby{森蔭}{もり|かげ}\ruby{深}{ふか}く\ruby{訪}{たず}ね\ruby{来}{き}て\\
        \ruby{新}{あた}らしき\ruby{喜}{よろこ}びに\ruby{満}{み}つ
        
        \vspace{\linespace}
        \item~\\
        % 2.
        \ruby{讃}{たた}へなむ\ruby{石狩}{いし|かり}の\\
        \ruby[g]{曠野}{の}に\ruby{打}{うち}\ruby{建}{た}てし\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        あかつきは\ruby{紫}{むらさき}の\\
        \ruby{夢}{ゆめ}にけむれり\\
        \ruby{雪解}{ゆき|げ}なる\ruby{陵}{おか}にのぼりて\\
        \ruby{恋}{こ}ひ\ruby{慕}{した}ふ\ruby{意気}{い|き}と\ruby{血汐}{ち|しお}の\\
        \ruby{花}{はな}\ruby{香}{かお}る\ruby{青史}{せい|し}の\ruby[g]{光栄}{はえ}よ\\
        \ruby{二春}{ふた|はる}を\ruby{魂}{こころ}の\ruby{故郷}{こ|きょう}に\ruby{契}{ちぎ}りては\\
