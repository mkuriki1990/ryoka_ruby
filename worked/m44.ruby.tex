...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{若}{わか}き\ruby{血潮}{ち|しお}の\ruby{踊}{おど}る\ruby{時}{とき}\\
        ...
        \ruby{薫}{かお}る\ruby{木影}{こ|かげ}に\ruby{立}{た}ちよれば\\
        \ruby{長風}{ちょう|ふう}\ruby{夏}{なつ}の\ruby{雲}{くも}ゆらぎ\\
        \ruby{秋}{あき}は\ruby{牧場}{まき|ば}の\ruby{夕}{ゆう}まぐれ\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{世}{よ}の\ruby{濁流}{だく|りゅう}を\ruby{叱{\UTF{96C7}}}{しっ|た}して\\ % UTF 咜
        \ruby{巨人}{きょ|じん}の\ruby{叫}{さけ}び\ruby{茲}{ここ}にあり
        
        \vspace{\linespace}
        \item~\\
        % 6.
        \ruby{浮華}{ふ|か}\ruby{軽佻}{けい|ちょう}の\ruby{風}{かぜ}あれて\\
        \ruby{驕奢}{きょう|しゃ}の\ruby{波}{なみ}は\ruby{狂}{くる}ふとも\\
        \ruby{北斗}{ほく|と}の\ruby{光}{ひかり}\ruby{清}{きよ}ければ\\
        \ruby{世}{よ}は\ruby[g]{永久}{とこしへ}に\ruby{我}{わが}\ruby{世}{よ}なり\\
        \ruby{聞}{き}けや\ruby{人々}{ひと|びと}\ruby{北州}{ほく|しゅう}に\\
