...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \ruby{雲}{くも}とまがふ\ruby{万朶}{ばん|だ}の\ruby{桜花}{おう|か}\ruby[g]{久遠}{くをん}に\ruby{萎}{な}えざるを。\\
    \ruby[g]{寮友}{とも}よ\ruby{徒}{いたづ}らに\ruby{明日}{あ|す}の\ruby[g]{運命}{さだめ}を
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{建}{た}てし\ruby{自由}{じ|いう}と\ruby{自治}{じ|ち}の\ruby{城}{しろ}\\
        その\ruby{源}{みなもと}は\ruby{遠}{とお}くして\\
        \ruby{濁世}{だく|せい}\ruby{叱{\CID{8411}}}{しっ|た}す\ruby[g]{六十年}{むそとせ}の\\ % CID 咜
        ...
        \ruby{降魔}{ごう|ま}の\ruby{剣}{つるぎ}かざすとき\\
        \ruby{狂}{くる}へる\ruby{{\UTF{98b7}}}{かぜ}も\ruby{声}{こえ}ひそむ % CID 颷
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{廻}{めぐ}りて\ruby{早}{はや}きその\ruby{三年}{み|とせ}\\
