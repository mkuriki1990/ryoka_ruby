...
\ruby{雨}{あめ}\ruby{降}{ふ}らば\ruby{雨}{あめ}\ruby{降}{ふ}るもよし 
\ruby{風}{かぜ}\ruby{吹}{ふ}かば\ruby{風}{かぜ}\ruby{吹}{ふ}くもよし\\
...
\ruby{人生}{じん|せい}\ruby{夢}{ゆめ}もなければ\ruby{恋}{こい}もなし。\\
\ruby{響}{とどろ}く\ruby{雷鳴}{らい|めい}　\ruby{握}{にぎ}る\ruby{舵輪}{だ|りん}　
\ruby{睨}{にら}むコンパス\ruby{六分儀}{りく|ぶん|ぎ}\\
\ruby{吾}{われ}ら\ruby{海}{うみ}\ruby{行}{ゆ}く\ruby{{\UTF{9dd7}}鳥}{かもめ|どり}　さらば\ruby{歌}{うた}わん\ruby{哉}{かな}\\ % CID 鷗
...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{男}{おとこ}と\ruby{生}{う}まれて\ruby{情}{なさけ}はあれど\\
        \ruby{母}{はは}を\ruby{見捨}{み|す}てて\ruby{浪}{なみ}\ruby{越}{こ}えてゆく\\
	...
	\begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 2.
        \ruby{朝日}{あさ|ひ}\ruby{夕日}{ゆう|ひ}をデッキに\ruby{浴}{あ}びて\\
        \ruby{続}{つづ}く\ruby{海原}{うな|ばら}\ruby{一筋道}{ひと|すじ|みち}を\\
        \ruby[g]{大和}{やまと}\ruby[g]{男子}{おのこ}が\ruby{心}{こころ}に\ruby{秘}{ひ}めて\\
        \ruby{行}{ゆ}くや\ruby{万里}{ばん|り}の\ruby{荒浪}{あら|なみ}\ruby{越}{こ}えて
	...
	\begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 3.
        \ruby{浪}{なみ}の\ruby[g]{彼方}{かなた}の\ruby{南氷洋}{なん|ぴょう|よう}は\\
