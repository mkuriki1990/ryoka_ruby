...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{怨嗟}{ゑん|さ}の\ruby{声}{こえ}の\ruby{収}{おさ}まるや\\
        \ruby{逆巻}{さか|ま}く\ruby{波}{なみ}も\ruby{和}{なご}み\ruby{来}{き}て\\
        \ruby{星影}{ほし|かげ}\ruby{淡}{あわ}き\ruby[g]{東雲}{しののめ}に\\
        ...
        \ruby{我}{われ}には\ruby{尚武}{しょう|ぶ}の\ruby{気魄}{き|はく}あり
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{巍峨}{ぎ|が}とそそれる\ruby{自由}{じ|ゆう}の\ruby{城}{しろ}\\
        ...
        \item~\\
        % 4.
        \ruby{孤城}{こ|じょう}に\ruby{春}{はる}の\ruby{訪}{おとず}れて\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{理想}{り|そう}の\ruby{華}{はな}を\ruby{咲}{さ}かせんと\\
        ...
        \item~\\
        % 6.
        いざや\ruby{勝利}{しょう|り}の\ruby{盃}{さかずき}を\\
        \ruby{平和}{へい|わ}の\ruby[g]{女神}{かみ}に\ruby{捧}{ささ}げつつ\\
        \ruby{右手}{め|て}に\ruby{正義}{せい|ぎ}の\ruby{剣}{けん}を\ruby{執}{と}り\\
        \ruby{左手}{ゆん|で}に\ruby{自由}{じ|ゆう}の\ruby{楯}{たて}を\ruby{持}{じ}し\\
        \ruby{若}{わか}き\ruby{血潮}{ち|しお}の\ruby{鳴}{な}るがまま\\
        \ruby{祝}{いわ}ひ\ruby{謳}{うた}わん\ruby{記念祭}{き|ねん|さい}
