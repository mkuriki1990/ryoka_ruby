...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 1.
        \ruby[g]{{\CID{8580}}統}{しんとう}\ruby{二千}{に|せん}\ruby{五百年}{ご|ひゃく|ねん}\\ % CID 神
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{{\CID{8452}}}{とく}\ruby{乾坤}{けん|こん}を\ruby{被}{かば}ふ\ruby{可}{べ}き\\ % CID 德
        ...
        \ruby{希望}{き|ぼう}の\ruby{色}{いろ}に\ruby[g]{{\CID{7635}}}{あふ}れずや % CID 溢
