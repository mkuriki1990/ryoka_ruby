...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{綾}{あや}なす\ruby[g]{紫雲}{くも}を\ruby{分}{わ}け\ruby{出}{で}でて\\
        ...
        \item~\\
        % 2.
        \ruby{陽光}{よう|こう}\ruby{燦然}{さん|ぜん}\ruby{乱}{みだ}れ\ruby{入}{い}る\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{聖}{きよ}き\ruby{都}{みやこ}に\ruby[g]{寂寥}{さびしさ}の\\
        \ruby{静}{しづ}かに\ruby{迫}{せま}る\ruby{此}{こ}の\ruby{夕}{ゆう}べ\\
        ...
        \ruby{雪}{ゆき}の\ruby{大路}{おお|じ}を\ruby{歩}{あゆ}みつつ\\
        \ruby{声}{こえ}をかぎりに\ruby[g]{寮歌}{うた}うたふ\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 5.
        \ruby{高}{たか}き「\ruby{理想}{り|そう}」と「\ruby{純情}{じゅん|じょう}」に\\
