...
\begin{enumerate} % 番号の箇条書き ここから
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \ruby{理想}{り|さう}のあとに\ruby[g]{憧憬}{あこが}れて\\
        \ruby{楡}{にれ}の\ruby{花}{はな}\ruby{散}{ち}る\ruby[g]{学都}{みやこ}にぞ\\
        \ruby[g]{啓示}{さとし}を\ruby{求}{もと}む\ruby[g]{若人}{わこうど}は\\
        \ruby[g]{綺花}{はな}を\ruby{流}{なが}して\ruby{逝}{ゆ}く\ruby{水}{みづ}に\\
        \ruby{十九}{じふ|く}の\ruby{春}{はる}を\ruby{嘆}{なげ}くなり
        ...
        \ruby[g]{白雲}{くも}\ruby{流}{なが}れゆく\ruby[g]{手稲山}{やま}\ruby{静}{しづ}か
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 3.
        \ruby[g]{学堂}{みどう}の\ruby[g]{古鐘}{かね}の\ruby{沈}{しづ}みゆき\\
        \ruby{楡陵}{ゆ|りょう}の\ruby[g]{蒼空}{そら}に\ruby[g]{銀月}{つき}\ruby{冴}{さ}えて\\
        \ruby{羊}{ひつじ}の\ruby{群}{むれ}の\ruby[g]{片影}{かげ}もなし\\
        \ruby[g]{沈黙}{しじま}の\ruby[g]{原始林}{もり}に\ruby{散}{ち}りしける\\
    ...
    \begin{minipage}[c]{\blocksize}
        ...
        \item~\\
        % 5.
        \ruby{北斗}{ほく|と}は\ruby{遠}{とほ}く\ruby[g]{七星}{ほし}\ruby{清}{きよ}し\\
        「\ruby{妄執}{まふ|しふ}」の\ruby[g]{現世}{よ}を\ruby{見下}{み|おろ}して\\
        \ruby{真実一路}{しん|じつ|いち|ろ}の\ruby{迪恵}{みち|たづ}ぬ\\
        「\ruby{意気}{い|き}」と「\ruby{血潮}{ち|しほ}」に\ruby{生}{い}くる\ruby{子}{こ}の\\
